...
import { ygKoridorData25, agacbudama25 } from '../../data/mockData';
...
export default function AgacBudamaSlide() {
    ...
    const rawData = activeTab === 'budama' ? agacbudama25 : ygKoridorData25;
        ...
        <div className={`flex flex-col h-full w-full bg-base-100 ${isFullscreen ? 'fixed inset-0 z-50 p-8' : 'p-4 md:p-6'} overflow-hidden`}>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <h2 className={`font-black tracking-tight ${isFullscreen ? 'text-3xl' : 'text-2xl'}`}>2025 Yılı Seviye-2 Ağaç Budama ve YG Koridor Açma Çalışmaları</h2>
                    </div>
                    <p className="text-base-content/50 text-sm font-medium"></p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6 shrink-0">
                <div className="bg-emerald-50 border border-emerald-100 p-4 rounded-2xl flex items-center justify-between shadow-sm">
                    <div>
                        <p className="text-emerald-600 text-[10px] font-black uppercase tracking-widest mb-1">TTOPLAM BUDANAN MESAFE</p>
            ...
            <div className="flex flex-wrap items-center justify-between gap-3 mb-4 bg-base-200/50 p-3 rounded-2xl border border-base-200 shrink-0">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <ExportExcelButton data={filteredData} fileName={`${activeTab}_Data_2025`} />
                </div>
            </div>
