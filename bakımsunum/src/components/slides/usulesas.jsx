...
const CARDS = [
    ...
    },
    {
        ...
        puan: [
            ...
            <><strong style={{ color: '#f59e0b', fontWeight: 800 }}>İş güvenliği ekipman harcamaları</strong> kapsama girdi</>,
        ],
    ...
    },
    {
        ...
        puan: [
            ...
            <><strong style={{ color: '#ef4444', fontWeight: 800 }}>Koridor açma işleri 3. seviye kapsamına girdi</strong></>,
            <><strong style={{ color: '#ef4444', fontWeight: 800 }}>Hat güzergahı değişikliği</strong> → yatırım harcaması olarak raporlanabilir</>,
        ],
    ...
    },
    {
        ...
        puan: [
            <>1. seviye bakım: ormanlık alanlarda <strong style={{ color: '#8b5cf6', fontWeight: 800 }}>yıllık zorunlu</strong> (eskiden 2 yılda 1)</>,
            <>2. seviye bakım: ormanlık alanlarda <strong style={{ color: '#8b5cf6', fontWeight: 800 }}>yıllık zorunlu</strong> (eskiden 5 yılda 1)</>,
    ...
    },
    {
        ...
        puan: [
            <>Toplam bütçenin en az <strong style={{ color: '#ec4899', fontWeight: 800 }}>%75'i 3. seviye bakıma ayrılacak</strong></>,
            <>Tarife üst sınırı <strong style={{ color: '#ec4899', fontWeight: 800 }}>%105'ten %110'a</strong> yükseltildi</>,
            'Dönem içi Kurul onayıyla bütçe revizyonu mümkün',
            <><strong style={{ color: '#ec4899', fontWeight: 800 }}>TEDAŞ kitabında olmayan kalemler</strong> 3. seviyede yapılamaz</>,
        ],
